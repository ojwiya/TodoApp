...
var getBanner = function() {
    ...
    return _.template(['/**',
        ' * generator-sublime - Yeoman generator for scaffolfding the standard configuration root files like .gitignore, .jshintrc, .jscsrc etc...',
        ' * @date Sat Jun 25 2016 14:21:12 GMT+0000 (UTC)',
        ' * @version v2.0.13',
        ' * @link https://github.com/mcfly-io/generator-sublime#readme',
        ' * @license MIT',
        ' */',
        ''
    ].join('\n'))({
