...
var getRepository = function() {
    var repository = 'https://github.com/ojwiya/TodoApp';
    try {
...
module.exports = function() {
    ...
    var constants = {
        ...
        fonts: {
            src: ['./' + clientFolder + '/fonts/*.*', './' + clientFolder + '/fonts/{{targetName}}/**/*.*', './node_modules/ionic-sdk/release/fonts/*.*', './node_modules/font-awesome/fonts/*.*', './node_modules/bootstrap/dist/fonts/*.*'], // you can also add a specific src_appname
            dest: 'fonts'
        },
        html: {
